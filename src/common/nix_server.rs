...
use crate::nix::{
    CommaArgs, DevelopTools, DiffDerivationsArgs, EcosystemToolArgs, ExplainPackageArgs,
    FindCommandArgs, GetBuildLogArgs, GetClosureSizeArgs, GetPackageInfoArgs, NixBuildArgs,
    NixCommandHelpArgs, NixDevelopArgs, NixEvalArgs, NixLocateArgs, NixLogArgs, NixRunArgs,
    NixosBuildArgs, RunInShellArgs, SearchOptionsArgs, SearchPackagesArgs, ShowDerivationArgs,
    WhyDependsArgs,
};
use rmcp::{
    handler::server::{
